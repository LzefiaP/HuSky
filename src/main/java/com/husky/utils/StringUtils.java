...
public class StringUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.alibaba.dubbo.common.utils.StringUtils.class);
    ...
    public static String getQueryStringValue(String qs, String key) {
        Map<String, String> map = com.alibaba.dubbo.common.utils.StringUtils.parseQueryString(qs);
        return map.get(key);
    }
