...
public class PositiveRecord extends Number {


    private static final long serialVersionUID = -1996586262303151050L;
    private final AtomicInteger i;

    public PositiveRecord() {
        i = new AtomicInteger();
    }

    public PositiveRecord(int initialValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PositiveRecord)) return false;
        PositiveRecord other = (PositiveRecord) obj;
